  ...
  return (
    <div className="w-full flex flex-col items-center">
      {filteredLeads && leads.length > 0 ? (
        ...
        <EmptyDashboard header={'Leads'} msg={'No Leads Yet'} />
      )}
    </div>
  );
}
  ...
  return (
    <div className="lg:w-full w-[98%]  lg:p-[6%]  flex flex-col justify-center items-center  ">
      <div className="flex flex-col items-start justify-center w-full border-gray-200 border-[1px] gap-4 rounded-md ">
        ...
        <div className="p-3 bg-white w-full sm:py-16 font-manrope flex flex-col ">
          <table className="min-w-full font-manrope h-[40px] overflow-scroll  lg:divide-y lg:divide-gray-200">
            <thead className="hidden  bg-[#F6F9FF] lg:table-header-group">
              <tr>
                <td className="px-6 py-4 text-sm font-manrope font-medium text-gray-400 whitespace-normal">
                  Name
                </td>

                <td className="px-6 py-4 text-sm font-medium font-manrope text-gray-400 whitespace-normal">
                  Email
                </td>
            ...
            <tbody className="divide-y divide-gray-200">
              {leads
                ...
                .map((list, i) => {
                  return (
                    <tr key={i}>
                      <td className="px-6 py-4 text-sm  font-manrope font-medium text-gray-900 whitespace-nowrap">
                        {list.Name}
                        <div className="mt-1 lg:hidden">
                          <p className="font-medium text-gray-500">{list.Email}</p>
                        </div>
                      </td>
                      ...
                      <td className="px-6 py-4 text-sm font-medium font-manrope text-right text-gray-900 lg:text-left whitespace-nowrap">
                        {list.Phone}
                        <div className="flex items-center justify-end font-manrope mt-1 font-medium lg:hidden">
                          {sortDate(list.createdAt)}
                        </div>
                      </td>

                      <td className="hidden px-6 py-4 text-sm font-medium font-manrope text-gray-900 lg:table-cell whitespace-nowrap">
