function BarHeader({ date, confidence, exportData }) {
  return (
    <div className="flex w-full items-start justify-between  flex-col lg:flex-row gap-6 p-3 ">
      ...
      <div className="flex flex-[40%] items-end justify-end">
        {exportData && (
          <button className="flex flex-row rounded-lg items-center font-manrope w-fit p-4 text-white font-[700] gap-4  bg-[#1261AC]">
            <p>Export</p>
