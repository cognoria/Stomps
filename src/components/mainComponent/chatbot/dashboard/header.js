      ...
      <div className="flex flex-[60%] gap-4 items-start ">
        {date && (
          <div className="relative">
            <input
              type="date"
              className="appearance-none py-[10px] lg:py-[20px] border border-gray-300 font-medium font-manrope placeholder:font-medium placeholder:font-manrope placeholder:text-sm rounded px-2 lg:px-4 w-[160px] lg:w-[180px] leading-tight focus:outline-none focus:border-blue-500"
            ...
            {/* <img
              ...
              alt="Calendar Icon"
              className="absolute right-0 top-0 hidden lg:block mt-2 mr-3 h-6 w-6 pointer-events-none"
            /> */}
          </div>
        )}
        ...
        {/* {confidence && (
          <div className="relative">
            ...
            <img
              ...
              alt="Calendar Icon"
              className="absolute right-1 hidden lg:block top-0 mt-4 mr-3 h-6 w-6 pointer-events-none"
            />
            <img
              src="/images/chatbox/filter.svg"
              alt="Calendar Icon"
              className="absolute left-1 hidden lg:block top-0 mt-4 mr-3 h-6 w-6 pointer-events-none"
            />
          </div>
        )} */}
      </div>
